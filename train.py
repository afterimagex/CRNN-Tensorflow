...
from core.trainer import train_net
...
if __name__ == '__main__':
    ...
    data_loader = TextFeatureReader(tfrecords_dir=cfg.TRAIN.DATABASE,
                                    prefix='train',
                                    augment_online=cfg.TRAIN.DATA_AUGMENT)

    train_net(coordinator, data_loader)